import { updatePropertyAction, getPropertyById } from '@/app/actions/properties'
...
export default async function EditPropertyPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="space-y-4">
          <nav aria-label="Breadcrumb" className="flex">
            <ol className="flex items-center space-x-2 text-sm text-gray-500 font-medium font-sf-pro">
              ...
              <li aria-current="page" className="text-[#19322F]">Edit Listing</li>
            </ol>
          </nav>
          <div>
      ...
      <PropertyForm initialData={property} onSubmit={updatePropertyAction} />
    </div>
  )
}
