            ...
            <section className="py-12 md:py-16">
                <div className="max-w-3xl mx-auto text-center space-y-8">
                    ...
                    <div className="flex items-center justify-center gap-3 overflow-x-auto hide-scroll py-2 px-4 -mx-4">
                        <button onClick={() => handleTypeSelect('All')} className={typeClasses('All')}>All</button>
                        <button onClick={() => handleTypeSelect('House')} className={typeClasses('House')}>House</button>
                        <button onClick={() => handleTypeSelect('Apartment')} className={typeClasses('Apartment')}>Apartment</button>
                        <button onClick={() => handleTypeSelect('Villa')} className={typeClasses('Villa')}>Villa</button>
                        <button onClick={() => handleTypeSelect('Penthouse')} className={typeClasses('Penthouse')}>Penthouse</button>
